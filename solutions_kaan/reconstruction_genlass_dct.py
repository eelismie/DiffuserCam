"""
This script will load the PSF data and raw measurement and get the reconstruction by generalized LASSO with DCT problem.

```bash
python solutions/reconstruction_genlass_dct.py --psf_fp data/our_dataset/psf/psf.png --data_fp data/our_dataset/diffuser_imgs/img1.png --save data/our_dataset/reconstructions/genlasso_dct/img1.png --acc_thresh 0.0 --n_iter 600
```
