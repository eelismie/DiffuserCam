...
```bash
python solutions/reconstruction_nnTV.py --psf_fp data/our_dataset/psf/psf.png --data_fp data/our_dataset/diffuser_imgs/img1.png --save data/our_dataset/reconstructions/nnTV/img1.png --acc_thresh 0.0007
```
